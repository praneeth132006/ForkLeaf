      ...
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 mb-16">
          ...
          <div className="md:col-span-2 flex flex-col gap-6">
            ...
            <p className="text-sm leading-relaxed max-w-sm">
              The seamless blend of WYSIWYG editing and raw markdown power. Write once, see it live,
          ...
          <div className="flex flex-col gap-4">
            ...
            <a
              href="#features"
              className="text-sm hover:text-[var(--color-trail-teal)] transition-colors"
            >
              Features
            </a>
          ...
          <div className="flex flex-col gap-4">
            ...
            <a
              href="https://github.com/praneeth132006/MarkDown"
              target="_blank"
        ...
        <div className="pt-8 border-t border-[var(--color-contour)] flex flex-col md:flex-row justify-between items-center gap-4 text-xs">
          ...
          <div className="flex gap-4">
            {/* Twitter link */}
            <a href="#" className="hover:text-[var(--color-chalk)] transition-colors">
              Twitter
            </a>
            {/* Discord link */}
            <a href="#" className="hover:text-[var(--color-chalk)] transition-colors">
