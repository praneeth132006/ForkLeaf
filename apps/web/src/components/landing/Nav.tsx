  ...
  return (
    <header className="sticky top-0 z-40 border-b border-[var(--fl-border)]/70 bg-[var(--fl-bg)]/80 backdrop-blur-xl">
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-3.5">
        ...
        <nav className="hidden items-center gap-7 text-sm text-[var(--fl-muted)] md:flex">
          <a className="transition-colors hover:text-[var(--fl-text)]" href="#how">
            How it works
          </a>
          <a className="transition-colors hover:text-[var(--fl-text)]" href="#features">
            Features
          </a>
          <a className="transition-colors hover:text-[var(--fl-text)]" href="#pricing">
            Pricing
          </a>
          <a
            className="transition-colors hover:text-[var(--fl-text)]"
            href={REPO_URL}
            target="_blank"
            rel="noreferrer"
          >
