...
export const INSERT_DEFINITIONS: InsertDefinition[] = [
  ...
  {
    id: "flashcard",
    keywords: ["card", "anki", "spaced", "repetition", "memorise", "revise", "study", "quiz"],
    label: "Flashcard",
    hint: "A question and its answer, as a card in the note",
    icon: <Glyph d="M2.5 5h8.5v8.5H2.5zM5 2.5h8.5V11" />,
    rich: (editor) => editor.chain().focus().insertFlashcard().run(),
    markdown: { text: "Question :: Answer\n" },
  },
  {
    id: "canvas",
    keywords: ["board", "whiteboard", "mind", "map", "spatial", "brainstorm", "obsidian"],
    label: "Canvas",
    hint: "A board of cards and arrows, right here in the note",
    icon: <Glyph d="M2 2.5h5v4H2zM9 9.5h5v4H9zM7 4.5h4.5v5" />,
    rich: (editor) => editor.chain().focus().insertCanvas().run(),
